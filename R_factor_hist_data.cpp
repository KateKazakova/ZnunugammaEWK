...
#include "TROOT.h"
  ...
  TH1F *DrawRatioPlot(TString TitleY, TH1F* hist1, TH1F* hist2, TH1F* hist3, float setRangeA_Y = 0.81,
    ...
    TH1F* h_ratio2 = (TH1F*)hist2->Clone("Clone1");
  ...
  const char *fname[] = {
    ...
    TH1F *hist_iso_loose_temp_mk = new TH1F("hist_iso_loose_temp_mk", "hist_iso_loose_temp_mk", 33, -30, 36);
    TH1F *hist_iso_loose_temp_data = new TH1F("hist_iso_loose_temp_data", "hist_iso_loose_temp_data", 33, -30, 36);
 ...
 void R_factor_hist_data(){
   ...
   for(int i = 0; i < N; i++){
     tree->GetEntry(i);
       ...
       if(new_ftempname.Contains("MC16a")){
         if((ph_iso_et40 - 0.022*ph_pt) < 2.45 && (ph_isem == 0) ) hist_iso_tight_mk->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16a*sum_koef*weight/(sumw_MC16a));
         else if((ph_iso_et40 - 0.022*ph_pt) > 4.45 && ph_isem == 0) hist_iso_tight_mk->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16a*sum_koef*weight/(sumw_MC16a));
         else if((ph_iso_et40 - 0.022*ph_pt) < 2.45 && (ph_isem != 0 && (ph_isem & 0x27fc01) == 0 )) hist_iso_loose_mk->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16a*sum_koef*weight/(sumw_MC16a));
         else if((ph_iso_et40 - 0.022*ph_pt) > 4.45  && (ph_isem != 0 && (ph_isem & 0x27fc01) == 0 )) hist_iso_loose_mk->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16a*sum_koef*weight/(sumw_MC16a));
       }
      else if(new_ftempname.Contains("MC16d")){
         if((ph_iso_et40 - 0.022*ph_pt) < 2.45 && (ph_isem == 0) ) hist_iso_tight_mk->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16d*sum_koef*weight/(sumw_MC16a));
         else if((ph_iso_et40 - 0.022*ph_pt) > 4.45  && ph_isem == 0) hist_iso_tight_mk->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16d*sum_koef*weight/(sumw_MC16a));
         else if((ph_iso_et40 - 0.022*ph_pt) < 2.45 && (ph_isem != 0 && (ph_isem & 0x27fc01) == 0 )) hist_iso_loose_mk->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16d*sum_koef*weight/(sumw_MC16a));
         else if((ph_iso_et40 - 0.022*ph_pt) > 4.45 && (ph_isem != 0 && (ph_isem & 0x27fc01) == 0 )) hist_iso_loose_mk->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16d*sum_koef*weight/(sumw_MC16a));
      }
      else if(new_ftempname.Contains("MC16e")){
         if((ph_iso_et40 - 0.022*ph_pt) < 2.45 && (ph_isem == 0) ) hist_iso_tight_mk->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16e*sum_koef*weight/(sumw_MC16a));
         else if((ph_iso_et40 - 0.022*ph_pt) > 4.45 && ph_isem == 0) hist_iso_tight_mk->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16e*sum_koef*weight/(sumw_MC16a));
         else if((ph_iso_et40 - 0.022*ph_pt) < 2.45 && (ph_isem != 0 && (ph_isem & 0x27fc01) == 0 )) hist_iso_loose_mk->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16e*sum_koef*weight/(sumw_MC16a));
         else if((ph_iso_et40 - 0.022*ph_pt) > 4.45 && (ph_isem != 0 && (ph_isem & 0x27fc01) == 0 )) hist_iso_loose_mk->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16e*sum_koef*weight/(sumw_MC16a));
  }
}
  ...
  for(int i = 0; i < N; i++){
     ...
     if(new_ftempname.Contains("MC16a")){
       ...
       else if((ph_iso_et40 - 0.022*ph_pt) < 2.45 && (ph_isem != 0 && (ph_isem & 0x27fc01) == 0 ) ) hist_iso_loose_temp_mk->Fill((ph_iso_et40 - 0.022*ph_pt), lumi_mc16a*sum_koef*weight/(sumw_MC16a));
       ...
       else if((ph_iso_et40 - 0.022*ph_pt) > 4.45  && (ph_isem != 0 && (ph_isem & 0x27fc01) == 0 ) ) hist_iso_loose_temp_mk->Fill((ph_iso_et40 - 0.022*ph_pt), lumi_mc16a*sum_koef*weight/(sumw_MC16a));

     }
    else if(new_ftempname.Contains("MC16d")){
      if((ph_iso_et40 - 0.022*ph_pt) < 11.45 && (ph_iso_et40 - 0.022*ph_pt) > 4.45 && ph_isem == 0  ) hist_BE->Fill(ph_pt, lumi_mc16a*sum_koef*weight/(sumw_MC16a));
      else if((ph_iso_et40 - 0.022*ph_pt) < 2.45 && (ph_isem != 0 && (ph_isem & 0x27fc01) == 0 ) ) hist_iso_loose_temp_mk->Fill((ph_iso_et40 - 0.022*ph_pt), lumi_mc16d*sum_koef*weight/(sumw_MC16a));
      else if((ph_iso_et40 - 0.022*ph_pt) > 11.45 && (ph_iso_et40 - 0.022*ph_pt) < 29.45 && (ph_isem == 0) ) hist_E->Fill(ph_pt, lumi_mc16a*sum_koef*weight/(sumw_MC16a));
      else if((ph_iso_et40 - 0.022*ph_pt) > 4.45  && (ph_isem != 0 && (ph_isem & 0x27fc01) == 0 ) ) hist_iso_loose_temp_mk->Fill((ph_iso_et40 - 0.022*ph_pt), lumi_mc16d*sum_koef*weight/(sumw_MC16a));
    }
    else if(new_ftempname.Contains("MC16e")){
      if((ph_iso_et40 - 0.022*ph_pt) < 11.45 && (ph_iso_et40 - 0.022*ph_pt) > 4.45 && ph_isem == 0  ) hist_BE->Fill(ph_pt, lumi_mc16a*sum_koef*weight/(sumw_MC16a));
      else if((ph_iso_et40 - 0.022*ph_pt) < 2.45 && (ph_isem != 0 && (ph_isem & 0x27fc01) == 0 ) ) hist_iso_loose_temp_mk->Fill((ph_iso_et40 - 0.022*ph_pt), lumi_mc16e*sum_koef*weight/(sumw_MC16a));
      else if((ph_iso_et40 - 0.022*ph_pt) > 11.45 && (ph_iso_et40 - 0.022*ph_pt) < 29.45 && (ph_isem == 0) ) hist_E->Fill(ph_pt, lumi_mc16a*sum_koef*weight/(sumw_MC16a));
      else if((ph_iso_et40 - 0.022*ph_pt) > 4.45  && (ph_isem != 0 && (ph_isem & 0x27fc01) == 0 ) ) hist_iso_loose_temp_mk->Fill((ph_iso_et40 - 0.022*ph_pt), lumi_mc16e*sum_koef*weight/(sumw_MC16a));
    }
...
/// начало цикла по дереву данных
    ...
    for(int i = 0; i < N_data; i++){
      ...
      if(n_ph !=1 || n_mu !=0 || n_e_medium != 0) continue;
      //if((ph_iso_et40 - 0.022*ph_pt) < 11.45 && (ph_iso_et40 - 0.022*ph_pt) > 4.45 && ph_isem == 0  ) hist_BE->Fill(ph_pt, lumi_mc16a*sum_koef*weight/(sumw_MC16a));
      if((ph_iso_et40 - 0.022*ph_pt) < 2.45 && (ph_isem != 0 && (ph_isem & 0x27fc01) == 0 ) ) hist_iso_loose_temp_mk->Fill((ph_iso_et40 - 0.022*ph_pt), 1.0);
      //else if((ph_iso_et40 - 0.022*ph_pt) > 11.45 && (ph_iso_et40 - 0.022*ph_pt) < 29.45 && (ph_isem == 0) ) hist_E->Fill(ph_pt, lumi_mc16a*sum_koef*weight/(sumw_MC16a));
      else if((ph_iso_et40 - 0.022*ph_pt) > 4.45  && (ph_isem != 0 && (ph_isem & 0x27fc01) == 0 ) ) hist_iso_loose_temp_mk->Fill((ph_iso_et40 - 0.022*ph_pt), 1.0);
 ...
 DrawThreeHist("Tight", "Tight(MC)", "Loose'2(MC)" , "Loose'2(Data)", hist_iso_tight_mk,
