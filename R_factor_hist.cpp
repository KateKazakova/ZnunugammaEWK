...
#include "TROOT.h"
  ...
  TH1F *DrawRatioPlot(TString TitleY, TH1F* hist1, TH1F* hist2, float setRangeA_Y = 0.81,
    ...
    for(int i = 1; i<=nBins; i++){
      ...
      rel_uncert_overall = sqrt(pow(rel_uncert_from_2histo,2));
  ...
  TH1F *DrawThreeHist(TString name, TString band1, TString band2, TH1F *hist1, TH1F *hist2,
                        TString TitleX, TString TitleY, bool DrawPlot = false,
    ...
    //  hist1->SetMarkerStyle(43);
     ...
     //  leg1->AddEntry(hist1, Form("%s", band3.Data()),"lp");
      ...
      TLegend *leg4 = new TLegend(0.7191575,0.6392458,0.907789,0.8115988);
      ...
      if (DrawPlot){
        ...
        DrawRatioPlot(TitleY_sub.Data(), hist1, hist2, -1.0, 6.0);
      }
  ...
  const char *fname[104] = {
    ...
    TH1F *hist_iso_calo = new TH1F("hist_iso_calo", "hist_iso_calo", 33, -30, 36);
    TH1F *hist_iso_loose = new TH1F("hist_iso_loose", "hist_iso_loose", 33, -30, 36);
    TH1F *hist_iso_tight = new TH1F("hist_iso_tight", "hist_iso_tight", 33, -30, 36);
   ...
   for(int i = 0; i < N; i++){
     tree->GetEntry(i);
       ...
       if(new_ftempname.Contains("MC16a")){
         //if((ph_iso_et40 - 0.022*ph_pt) < 2.45 && (ph_isem == 0) ) hist_iso_tight->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16a*sum_koef*weight/(sumw_MC16a));
         //else if((ph_iso_et40 - 0.022*ph_pt) > 4.45 && ph_isem == 0) hist_iso_tight->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16a*sum_koef*weight/(sumw_MC16a));
         //else if((ph_iso_et40 - 0.022*ph_pt) < 2.45 && (ph_isem != 0 && (ph_isem & 0x1fc01) == 0 )) hist_iso_loose->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16a*sum_koef*weight/(sumw_MC16a));
         //else if((ph_iso_et40 - 0.022*ph_pt) > 4.45  && (ph_isem != 0 && (ph_isem & 0x1fc01) == 0 )) hist_iso_loose->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16a*sum_koef*weight/(sumw_MC16a));
       }
      else if(new_ftempname.Contains("MC16d")){
         //if((ph_iso_et40 - 0.022*ph_pt) < 2.45 && (ph_isem == 0) ) hist_iso_tight->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16d*sum_koef*weight/(sumw_MC16a));
         //else if((ph_iso_et40 - 0.022*ph_pt) > 4.45  && ph_isem == 0) hist_iso_tight->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16d*sum_koef*weight/(sumw_MC16a));
         //else if((ph_iso_et40 - 0.022*ph_pt) < 2.45 && (ph_isem != 0 && (ph_isem & 0x1fc01) == 0 )) hist_iso_loose->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16d*sum_koef*weight/(sumw_MC16a));
         //else if((ph_iso_et40 - 0.022*ph_pt) > 4.45 && (ph_isem != 0 && (ph_isem & 0x1fc01) == 0 )) hist_iso_loose->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16d*sum_koef*weight/(sumw_MC16a));
      }
      else if(new_ftempname.Contains("MC16e")){
         //if((ph_iso_et40 - 0.022*ph_pt) < 2.45 && (ph_isem == 0) ) hist_iso_tight->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16e*sum_koef*weight/(sumw_MC16a));
         //else if((ph_iso_et40 - 0.022*ph_pt) > 4.45 && ph_isem == 0) hist_iso_tight->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16e*sum_koef*weight/(sumw_MC16a));
         //else if((ph_iso_et40 - 0.022*ph_pt) < 2.45 && (ph_isem != 0 && (ph_isem & 0x1fc01) == 0 )) hist_iso_loose->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16e*sum_koef*weight/(sumw_MC16a));
         //else if((ph_iso_et40 - 0.022*ph_pt) > 4.45 && (ph_isem != 0 && (ph_isem & 0x1fc01) == 0 )) hist_iso_loose->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16e*sum_koef*weight/(sumw_MC16a));
  }
}
       ...
       for(int i = 0; i < N; i++){
          ...
          TString new_ftempname = TString(ftempname);
          if(new_ftempname.Contains("MC16a")){
            //if((ph_iso_et40 - 0.022*ph_pt) < 2.45 && ph_isem == 0) hist_iso_calo->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16a*sum_koef*weight/(sumw_MC16a));
            //else if((ph_iso_et40 - 0.022*ph_pt) > 4.45 && ph_isem == 0) hist_iso_calo->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16a*sum_koef*weight/(sumw_MC16a));
            //else if((ph_iso_et40 - 0.022*ph_pt) < 2.45 && (ph_isem != 0 && (ph_isem & 0x1fc01) == 0 )) hist_iso_loose->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16a*sum_koef*weight/(sumw_MC16a));
            //else if((ph_iso_et40 - 0.022*ph_pt) > 4.45 && (ph_isem != 0 && (ph_isem & 0x1fc01) == 0 )) hist_iso_loose->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16a*sum_koef*weight/(sumw_MC16a));
          }
         else if(new_ftempname.Contains("MC16d")){
            //if((ph_iso_et40 - 0.022*ph_pt) < 2.45 && ph_isem == 0 ) hist_iso_calo->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16d*sum_koef*weight/(sumw_MC16a));
            //else if((ph_iso_et40 - 0.022*ph_pt) > 4.45 && ph_isem == 0) hist_iso_calo->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16d*sum_koef*weight/(sumw_MC16a));
            //else if((ph_iso_et40 - 0.022*ph_pt) < 2.45 && (ph_isem != 0 && (ph_isem & 0x1fc01) == 0 )) hist_iso_loose->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16d*sum_koef*weight/(sumw_MC16a));
            //else if((ph_iso_et40 - 0.022*ph_pt) > 4.45 && (ph_isem != 0 && (ph_isem & 0x1fc01) == 0 )) hist_iso_loose->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16d*sum_koef*weight/(sumw_MC16a));
         }
         else if(new_ftempname.Contains("MC16e")){
            //if((ph_iso_et40 - 0.022*ph_pt) < 2.45 && ph_isem == 0 ) hist_iso_calo->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16e*sum_koef*weight/(sumw_MC16a));
            //else if((ph_iso_et40 - 0.022*ph_pt) > 4.45 && ph_isem == 0) hist_iso_calo->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16e*sum_koef*weight/(sumw_MC16a));
            //else if((ph_iso_et40 - 0.022*ph_pt) < 2.45 && (ph_isem != 0 && (ph_isem & 0x1fc01) == 0 )) hist_iso_loose->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16e*sum_koef*weight/(sumw_MC16a));
            //else if((ph_iso_et40 - 0.022*ph_pt) > 4.45 && (ph_isem != 0 && (ph_isem & 0x1fc01) == 0 )) hist_iso_loose->Fill(ph_iso_et40 - 0.022*ph_pt, lumi_mc16e*sum_koef*weight/(sumw_MC16a));
         }
       ...
       for(int i = 0; i < N; i++){
          ...
          TString new_ftempname = TString(ftempname);
          if(new_ftempname.Contains("MC16a")){
            if((ph_iso_et20 - 0.065*ph_pt) < 0.0 && (ph_isem == 0) ) hist_iso_tight->Fill(ph_iso_et20 - 0.065*ph_pt, lumi_mc16a*sum_koef*weight/(sumw_MC16a));
            else if((ph_iso_et20 - 0.065*ph_pt) > 2.0 && ph_isem == 0) hist_iso_tight->Fill(ph_iso_et20 - 0.065*ph_pt, lumi_mc16a*sum_koef*weight/(sumw_MC16a));
            else if(ph_iso_et20 - 0.065*ph_pt < 0.0 && (ph_isem != 0 && (ph_isem & 0x1fc01) == 0 ) ) hist_iso_loose->Fill(ph_iso_et20 - 0.065*ph_pt, lumi_mc16a*sum_koef*weight/(sumw_MC16a));
            else if((ph_iso_et20 - 0.065*ph_pt) > 2.0 && (ph_isem != 0 && (ph_isem & 0x1fc01) == 0 )) hist_iso_loose->Fill(ph_iso_et20 - 0.065*ph_pt, lumi_mc16a*sum_koef*weight/(sumw_MC16a));
          }
         else if(new_ftempname.Contains("MC16d")){
            if((ph_iso_et20 - 0.065*ph_pt) < 0.0 && (ph_isem == 0) ) hist_iso_tight->Fill(ph_iso_et20 - 0.065*ph_pt, lumi_mc16d*sum_koef*weight/(sumw_MC16a));
            else if((ph_iso_et20 - 0.065*ph_pt) > 2.0  && ph_isem == 0) hist_iso_tight->Fill(ph_iso_et20 - 0.065*ph_pt, lumi_mc16d*sum_koef*weight/(sumw_MC16a));
            else if(ph_iso_et20 - 0.065*ph_pt < 0.0 && (ph_isem != 0 && (ph_isem & 0x1fc01) == 0 ) ) hist_iso_loose->Fill(ph_iso_et20 - 0.065*ph_pt, lumi_mc16d*sum_koef*weight/(sumw_MC16a));
            else if((ph_iso_et20 - 0.065*ph_pt) > 2.0 && (ph_isem != 0 && (ph_isem & 0x1fc01) == 0 )) hist_iso_loose->Fill(ph_iso_et20 - 0.065*ph_pt, lumi_mc16d*sum_koef*weight/(sumw_MC16a));
         }
         else if(new_ftempname.Contains("MC16e")){
            if((ph_iso_et20 - 0.065*ph_pt) < 0.0 && (ph_isem == 0) ) hist_iso_tight->Fill(ph_iso_et20 - 0.065*ph_pt, lumi_mc16e*sum_koef*weight/(sumw_MC16a));
            else if((ph_iso_et20 - 0.065*ph_pt) > 2.0  && ph_isem == 0) hist_iso_tight->Fill(ph_iso_et20 - 0.065*ph_pt, lumi_mc16e*sum_koef*weight/(sumw_MC16a));
            else if(ph_iso_et20 - 0.065*ph_pt < 0.0 && (ph_isem != 0 && (ph_isem & 0x1fc01) == 0 ) ) hist_iso_loose->Fill(ph_iso_et20 - 0.065*ph_pt, lumi_mc16e*sum_koef*weight/(sumw_MC16a));
            else if((ph_iso_et20 - 0.065*ph_pt) > 2.0 && (ph_isem != 0 && (ph_isem & 0x1fc01) == 0 )) hist_iso_loose->Fill(ph_iso_et20 - 0.065*ph_pt, lumi_mc16e*sum_koef*weight/(sumw_MC16a));
         }
...
*/
  ...
  DrawThreeHist("Loose", "Loose'5", "Tight" ,hist_iso_loose,
                     hist_iso_tight ,"E_{T}^{cone20} - 0.065 p_{T}^{#gamma}, [GeV]", "Events", true,
                    true, "Loose/Tight");
